...
#1.1.1 Call in Libraries
library(plyr)
library(dplyr)
library (xlsx)

# 1.1.2 Call in R Source Code
source("1_R_FUNCTIONS/ExportXlsx.R")

## 1.2 IMPORT RAW DATA
HH.data <- read.delim("2_PROJECTS/2_STATE_SEASCAPE/Seascape_HH_wellbeing_2015_0715.txt")
DE.data <-read.delim("2_PROJECTS/2_STATE_SEASCAPE/Seascape_DE_data_2015_0716.txt") #fix path
district.data <-read.delim("2_PROJECTS/2_STATE_SEASCAPE/District_2015_0715.txt")
settlement.data <-read.delim("2_PROJECTS/2_STATE_SEASCAPE/Settlement_2015_0715.txt")
ethnic<- read.delim ("2_PROJECTS/2_STATE_SEASCAPE/State_Seascape_2015_ethnicities_2015_0716.txt") 
