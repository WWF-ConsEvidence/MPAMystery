# ----
# code:  Kofiau 2Yr Impact Summary Plots
# git branch: MPAMystery --> Social --> ImpactSummaries --> Kofiau
# 
...
# ----
# code sections:
#  1) Source Kofiau 2Yr Impact Summary Statistical Code
...
############################################################
#
# SECTION 1: Source Kofiau 2Yr Impact Summary Statistical Code
#
############################################################
# ----

source('ImpactSummaries/Kofiau/Kofiau.ImpactSumm.2yr.SigTests.R')
...
# 2.1 Food Security
Kof.MPAimpact.summ.fs.st <- ggplot(data=Kof.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       FS)) +
...
# 2.2 Material Assets
Kof.MPAimpact.summ.ma.st <- ggplot(data=Kof.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.pa.st <- ggplot(data=Kof.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 2.4 Marine Tenure
Kof.MPAimpact.summ.mt.st <- ggplot(data=Kof.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.se.st <- ggplot(data=Kof.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 3.1 Food Security
Kof.MPAimpact.summ.fs.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_segment(aes(x=0.6,xend=0.6,y=FS[Treatment=="Control"],yend=FS[Treatment=="MPA"]),
               lineend="square",
               size=1) +
  geom_point(data=Kof.impact.arrows,
             aes(x=x,y=FS,shape=""),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Kof.sig.pos["FS",],x=0.65,
           label=Kof.sig.labs["FS","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Kof.2yr.impacts$FS[Kof.2yr.impacts$Treatment=="MPA"]>
                                     Kof.2yr.impacts$FS[Kof.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.fs.labs.i + plot.guides.MPAimpact.summ

# 3.2 Material Assets
Kof.MPAimpact.summ.ma.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MA-MAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Kof.sig.pos["MA",],x=0.65,
           label=Kof.sig.labs["MA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Kof.2yr.impacts$MA[Kof.2yr.impacts$Treatment=="MPA"]>
                                     Kof.2yr.impacts$MA[Kof.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.ma.labs.i + plot.guides.MPAimpact.summ

# 3.3 Place Attachment
Kof.MPAimpact.summ.pa.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_point(data=Kof.impact.arrows,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Kof.sig.pos["PA",],x=0.65,
           label=Kof.sig.labs["PA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  geom_errorbar(aes(ymin=PA-PAErr,
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Kof.2yr.impacts$PA[Kof.2yr.impacts$Treatment=="MPA"]>
                                     Kof.2yr.impacts$PA[Kof.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.pa.labs.i + plot.guides.MPAimpact.summ

# 3.4 Marine Tenure
Kof.MPAimpact.summ.mt.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MT-MTErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Kof.sig.pos["MT",],x=0.65,
           label=Kof.sig.labs["MT","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Kof.2yr.impacts$MT[Kof.2yr.impacts$Treatment=="MPA"]>
                                     Kof.2yr.impacts$MT[Kof.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.mt.labs.i + plot.guides.MPAimpact.summ

# 3.5 School Enrollment
Kof.MPAimpact.summ.se.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=SE-SEErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Kof.sig.pos["SE",]-0.005,x=0.65,
           label=Kof.sig.labs["SE","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Kof.2yr.impacts$SE[Kof.2yr.impacts$Treatment=="MPA"]>
                                     Kof.2yr.impacts$SE[Kof.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
snapshot.Kof.MPAimpact.summ <- ggplot(data=Kof.2yr.std.impacts,
                                      aes(x=Domain,
                                          y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Kof.sig.labs[,"snapshot.labs"]) +
  ...
  labs(x="Human Well-Being Domain\n ",y="\n MPA Impact",
       title="Social Impacts of Kofiau dan Pulau Boo MPA") +
