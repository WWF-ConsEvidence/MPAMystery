...
Kof.sig.pos <- data.frame(mapply(i=Kof.2yr.impacts[Kof.2yr.impacts$Treatment=="MPA",c("PA","SE","MT","FS","MA")],
                                 ...
                                 outcome.sd=c(sd(impact.2yr[impact.2yr$MPAID==4 & !is.na(impact.2yr$MPAID),22],na.rm=T),
                                              (sd(impact.2yr[impact.2yr$MPAID==4 & !is.na(impact.2yr$MPAID),36],na.rm=T)/100),
                                              sapply(impact.2yr[impact.2yr$MPAID==4 & !is.na(impact.2yr$MPAID),c(29,7,14)],sd,na.rm=T)),
