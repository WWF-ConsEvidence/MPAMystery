...
# 
# github: kaclaborn/WWF-conservation-evidence/MPAMystery/Social/ImpactSummaries/BHS
...
# 
# ---- inputs ----
#  1) Source Dampier.ImpactSumm.2yr.SigTests.R 
...
source('MPAMystery/Social/ImpactSummaries/BHS/SignificanceTestCodes/Dampier.ImpactSumm.2yr.SigTests.R')
...
Damp.MPAimpact.summ.fs.st <- ggplot(data=Damp.2yr.status.trend,
                                    aes(Year,
                                        FS)) +
...
Damp.MPAimpact.summ.ma.st <- ggplot(data=Damp.2yr.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.pa.st <- ggplot(data=Damp.2yr.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.mt.st <- ggplot(data=Damp.2yr.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.se.st <- ggplot(data=Damp.2yr.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.fs.i <- ggplot(data=Damp.2yr.impacts,
  ...
  geom_segment(aes(x=0.6,xend=0.6,y=FS[Treatment=="Control"],yend=FS[Treatment=="MPA"]),
               lineend="square",
               size=1) +
  geom_point(data=Damp.impact.arrows,
             aes(x=x,y=FS,shape=""),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Damp.sig.pos["FS",],x=0.65,
           label=Damp.sig.labs["FS","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Damp.2yr.impacts$FS[Damp.2yr.impacts$Treatment=="MPA"]>
                                     Damp.2yr.impacts$FS[Damp.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Damp.MPAimpact.summ.ma.i <- ggplot(data=Damp.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MA-MAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Damp.sig.pos["MA",],x=0.65,
           label=Damp.sig.labs["MA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Damp.2yr.impacts$MA[Damp.2yr.impacts$Treatment=="MPA"]>
                                     Damp.2yr.impacts$MA[Damp.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Damp.MPAimpact.summ.pa.i <- ggplot(data=Damp.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=PA-PAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Damp.sig.pos["PA",],x=0.65,
           label=Damp.sig.labs["PA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Damp.2yr.impacts$PA[Damp.2yr.impacts$Treatment=="MPA"]>
                                     Damp.2yr.impacts$PA[Damp.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Damp.MPAimpact.summ.mt.i <- ggplot(data=Damp.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MT-MTErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Damp.sig.pos["MT",],x=0.65,
           label=Damp.sig.labs["MT","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Damp.2yr.impacts$MT[Damp.2yr.impacts$Treatment=="MPA"]>
                                     Damp.2yr.impacts$MT[Damp.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Damp.MPAimpact.summ.se.i <- ggplot(data=Damp.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=SE-SEErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Damp.sig.pos["SE",],x=0.65,
           label=Damp.sig.labs["SE","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Damp.2yr.impacts$SE[Damp.2yr.impacts$Treatment=="MPA"]>
                                     Damp.2yr.impacts$SE[Damp.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
snapshot.Damp.MPAimpact.summ <- ggplot(data=Damp.2yr.std.impacts,
                                       aes(x=Domain,
                                           y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Damp.sig.labs[,"snapshot.labs"]) +
  ...
  labs(x="Human Well-Being Domain\n ",y="\n MPA Impact",
       title="Social Impacts of Selat Dampier MPA") +
