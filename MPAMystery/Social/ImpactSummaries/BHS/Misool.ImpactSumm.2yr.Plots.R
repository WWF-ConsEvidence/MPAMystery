# ----
# code:  Dampier 2Yr Impact Summary Plots
...
# ----
# code sections:
#  1) Source Dampier 2Yr Impact Summary Statistical Code
...
source('ImpactSummaries/Dampier/Dampier.ImpactSumm.2yr.SigTests.R')
...
# 2.1 Food Security
Mis.MPAimpact.summ.fs.st <- ggplot(data=Mis.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       FS)) +
...
# 2.2 Material Assets
Mis.MPAimpact.summ.ma.st <- ggplot(data=Mis.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.pa.st <- ggplot(data=Mis.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 2.4 Marine Tenure
Mis.MPAimpact.summ.mt.st <- ggplot(data=Mis.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.se.st <- ggplot(data=Mis.BigFive.MPAimpact.summ.st,
                                   aes(Year,
                                       SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
