...
# 2.1 Food Security
Damp.MPAimpact.summ.fs.st <- ggplot(data=Damp.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        FS)) +
...
# 2.2 Material Assets
Damp.MPAimpact.summ.ma.st <- ggplot(data=Damp.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.pa.st <- ggplot(data=Damp.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 2.4 Marine Tenure
Damp.MPAimpact.summ.mt.st <- ggplot(data=Damp.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Damp.MPAimpact.summ.se.st <- ggplot(data=Damp.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
