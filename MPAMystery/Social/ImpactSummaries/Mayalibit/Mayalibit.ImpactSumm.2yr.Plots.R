# ----
# code:  Mayalibit 2Yr Impact Summary Plots
# git branch: MPAMystery --> Social --> ImpactSummaries --> Mayalibit
# 
...
# ----
# code sections:
#  1) Source Mayalibit 2Yr Impact Summary Statistical Code
...
############################################################
#
# SECTION 1: Source Mayalibit 2Yr Impact Summary Statistical Code
#
############################################################
# ----

source('ImpactSummaries/Mayalibit/Mayalibit.ImpactSumm.2yr.SigTests.R')
...
# 2.1 Food Security
Maya.MPAimpact.summ.fs.st <- ggplot(data=Maya.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        FS)) +
...
# 2.2 Material Assets
Maya.MPAimpact.summ.ma.st <- ggplot(data=Maya.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Maya.MPAimpact.summ.pa.st <- ggplot(data=Maya.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 2.4 Marine Tenure
Maya.MPAimpact.summ.mt.st <- ggplot(data=Maya.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Maya.MPAimpact.summ.se.st <- ggplot(data=Maya.BigFive.MPAimpact.summ.st,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
# 3.1 Food Security
Maya.MPAimpact.summ.fs.i <- ggplot(data=Maya.2yr.impacts,
  ...
  geom_segment(aes(x=0.6,xend=0.6,y=FS[Treatment=="Control"],yend=FS[Treatment=="MPA"]),
               lineend="square",
               size=1) +
  geom_point(data=Maya.impact.arrows,
             aes(x=x,y=FS,shape=""),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Maya.sig.pos["FS",],x=0.65,
           label=Maya.sig.labs["FS","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Maya.2yr.impacts$FS[Maya.2yr.impacts$Treatment=="MPA"]>
                                     Maya.2yr.impacts$FS[Maya.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.fs.labs.i + plot.guides.MPAimpact.summ

# 3.2 Material Assets
Maya.MPAimpact.summ.ma.i <- ggplot(data=Maya.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MA-MAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Maya.sig.pos["MA",],x=0.65,
           label=Maya.sig.labs["MA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Maya.2yr.impacts$MA[Maya.2yr.impacts$Treatment=="MPA"]>
                                     Maya.2yr.impacts$MA[Maya.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.ma.labs.i + plot.guides.MPAimpact.summ

# 3.3 Place Attachment
Maya.MPAimpact.summ.pa.i <- ggplot(data=Maya.2yr.impacts,
  ...
  geom_point(data=Maya.impact.arrows,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["PA",],x=0.65,
           label=Maya.sig.labs["PA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  geom_errorbar(aes(ymin=PA-PAErr,
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Maya.2yr.impacts$PA[Maya.2yr.impacts$Treatment=="MPA"]>
                                     Maya.2yr.impacts$PA[Maya.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.pa.labs.i + plot.guides.MPAimpact.summ

# 3.4 Marine Tenure
Maya.MPAimpact.summ.mt.i <- ggplot(data=Maya.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MT-MTErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Maya.sig.pos["MT",],x=0.65,
           label=Maya.sig.labs["MT","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Maya.2yr.impacts$MT[Maya.2yr.impacts$Treatment=="MPA"]>
                                     Maya.2yr.impacts$MT[Maya.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.mt.labs.i + plot.guides.MPAimpact.summ

# 3.5 School Enrollment
Maya.MPAimpact.summ.se.i <- ggplot(data=Maya.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=SE-SEErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Maya.sig.pos["SE",],x=0.65,
           label=Maya.sig.labs["SE","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Maya.2yr.impacts$SE[Maya.2yr.impacts$Treatment=="MPA"]>
                                     Maya.2yr.impacts$SE[Maya.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
snapshot.Maya.MPAimpact.summ <- ggplot(data=Maya.2yr.std.impacts,
                                       aes(x=Domain,
                                           y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Maya.sig.labs[,"snapshot.labs"]) +
  ...
  labs(x="Human Well-Being Domain\n ",y="\n MPA Impact",
       title="Social Impacts of Teluk Mayalibit MPA") +
