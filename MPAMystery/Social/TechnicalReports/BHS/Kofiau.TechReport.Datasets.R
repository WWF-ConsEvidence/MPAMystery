...
#  2) Source Kofiau.TechReport.SigTests.R 
# 
# ---- code sections ----
...
# ---- 1.1 Source MPA.Mystery and statistical test results from "Kofiau.TechReport.SigTests.R" ----

source("MPAMystery/Social/MPA.Mystery.R")  # !!! No need to re-source this if already done from previous script
source("MPAMystery/Social/TechnicalReports/BHS/Kofiau.TechReport.SigTests.R")
