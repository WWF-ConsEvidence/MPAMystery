...
#    each settlementID.
# ADD: Ethnicity, impacts, and std.impacts files here
# 
# 
# ---- code sections ----
#  1) Import Libraries and Data, and Subset
#  2) "Big Five" Indexes
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
# ---- SECTION 1: Import Libraries and Data, and Subset ----
#
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
...
source('MPAMystery/Social/SourcedScripts/SQLqueries_AccessODBC.R')
...
HHData <- read.csv('MPAMystery/Social/FlatDataFiles/KC_HHData_ForMPAMystery.csv',header=T,sep=',')

IndDemos <- read.csv('MPAMystery/Social/FlatDataFiles/KC_IndDemos_ForMPAMystery.csv',header=T,sep=',')
IndDemos <- left_join(IndDemos,HHData[,c("HouseholdID","SettlementID")],by="HouseholdID")

Settlements <- read.csv('MPAMystery/Social/FlatDataFiles/HH_tbl_SETTLEMENT.csv',header=T,sep=',')
Settlements <- Settlements[,c(1,3:5)]

# Whichever option you chose above, you will still need to upload Ethnicity data from a flat file
HHEthnicity <- read.delim ("MPAMystery/Social/FlatDataFiles/Ethnic_2015_0705.txt")


# ---- 1.3 Source Revised_script to upload 2 year impact data and p values for impacts ----

source('MPAMystery/Social/SourcedScripts/Revised_script_KC.R',print.eval=T)
...
std.impact.2yr <- read.csv('MPAMystery/Social/FlatDataFiles/MPA_2yr_std_impacts&se.csv',header=TRUE)
...
# ---- 1.5 Remove settlements without post-baseline data, re-code Kaimana control settlements ----
...
Settlements <- Settlements[!is.na(Settlements$SettlementID) &
                             ...
                             Settlements$SettlementID!=101,c(1,3:5)]
...
# ---- 1.6 Define monitoring year for each MPA ----
...
# ---- 1.7 Subset variables from HHData for Big Five calculations & descriptive statistics ----
