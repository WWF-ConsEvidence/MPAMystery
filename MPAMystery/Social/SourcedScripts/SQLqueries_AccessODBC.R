...
iif(AssetCarTruck>989,990,AssetCarTruck*11) as CarTruckClean, 
...
iif(AssetPhoneCombined>989,990,AssetPhoneCombined*4) as PhoneCombinedClean, 
iif(AssetTV>989,990,AssetTV*2) as TVClean, 
iif(AssetEntertain>989,990,AssetEntertain*1) as EntertainClean, 
