...
# HHData <- read.csv('MPAMystery/Social/FlatDataFiles/BHS/KC_HHData_ForMPAMystery.csv',header=T,sep=',')
# 
# IndDemos <- read.csv('MPAMystery/Social/FlatDataFiles/BHS/KC_IndDemos_ForMPAMystery.csv',header=T,sep=',')
# IndDemos <- left_join(IndDemos,HHData[,c("HouseholdID","SettlementID")],by="HouseholdID")
# 
# Settlements <- read.csv('MPAMystery/Social/FlatDataFiles/BHS/HH_tbl_SETTLEMENT.csv',header=T,sep=',')
# Settlements <- Settlements[,c(1,3:5)]

# Whichever option you chose above, you will still need to upload Ethnicity data from a flat file
HHEthnicity <- read.delim ("MPAMystery/Social/FlatDataFiles/BHS/Ethnic_2015_0705.txt")
