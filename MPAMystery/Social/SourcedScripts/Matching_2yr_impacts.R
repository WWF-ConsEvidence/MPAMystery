...
write.table(ndrops.mpa, "MPAMystery/Social/FlatDataFiles/BHS/MPA_time_ndrops_byMPA.txt", sep=",", row.names=FALSE)
write.table(ndrops.settlement, "MPAMystery/Social/FlatDataFiles/BHS/MPA_time_ndrops_bySettlement.txt", sep=",", row.names=FALSE)
