...
HH.data <- read.delim("2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/HHdata_raw_2015_0704.txt")
DE.data <-read.delim("2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/Demographic_raw_2015_0704.txt")
district.data <-read.delim("2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/District_codes_2015_0704.txt")
Ethnic<- read.delim ("2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/Ethnic_2015_0705.txt")
...
write.table(ed.level.unique, "2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/ed.level.unique.txt", sep=",")
ed.level.unique <-read.delim("2_PROJECTS/1_COMPUTE_HWB_INDICATORS/Raw_data/ed.level.unique.coded.txt")
...
# ======
# 5.6 Recode Kaimana
settlement.data <-read.delim("2_PROJECTS/2_STATE_SEASCAPE/Settlement_2015_0715.txt")
...
source("Social impacts, BHS -- Kelly/R codes & data/Compute_BigFive_HWB_KC.R")

# ======
# 4.2 Source variable outcome function

source('5_SOCIAL_IMPACTS2YR/Variable_outcome.R')
