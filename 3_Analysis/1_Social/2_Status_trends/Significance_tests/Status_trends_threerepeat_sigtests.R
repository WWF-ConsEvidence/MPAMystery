# 
# code:  Status & Trends Significance Tests, for data with three repeats
# 
...
colnames(FreqTables) <- c("t0","repeat1","repeat2","repeat3")
                         ...
                         function(a) {
                           p.for.function <- 
                             if(sum(FreqTables$t0[FreqTables$Variable==a])==0) {
                               FreqTables$repeat3[FreqTables$Variable==a &
                                                    FreqTables$repeat3!=0] 
                             } else {FreqTables$t0[FreqTables$Variable==a &
                                                     FreqTables$t0!=0] }
                           data.for.function <- 
                             if(sum(FreqTables$t0[FreqTables$Variable==a])==0) {
                               FreqTables$repeat3[FreqTables$Variable==a]
                             } else {FreqTables$repeat3[FreqTables$Variable==a &
                                                          FreqTables$t0!=0]}
