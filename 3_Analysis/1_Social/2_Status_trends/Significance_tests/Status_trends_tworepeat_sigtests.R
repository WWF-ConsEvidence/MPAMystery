# 
# code:  Status & Trends Significance Tests, for data with two repeats
# 
...
colnames(FreqTables) <- c("t0","repeat1","repeat2")
                         ...
                         function(a) {
                           p.for.function <- 
                             if(sum(FreqTables$t0[FreqTables$Variable==a])==0) {
                               FreqTables$repeat2[FreqTables$Variable==a &
                                                    FreqTables$repeat2!=0] 
                             } else {FreqTables$t0[FreqTables$Variable==a &
                                                     FreqTables$t0!=0] }
                           data.for.function <- 
                             if(sum(FreqTables$t0[FreqTables$Variable==a])==0) {
                               FreqTables$repeat2[FreqTables$Variable==a]
                             } else {FreqTables$repeat2[FreqTables$Variable==a &
                                                          FreqTables$t0!=0]}
