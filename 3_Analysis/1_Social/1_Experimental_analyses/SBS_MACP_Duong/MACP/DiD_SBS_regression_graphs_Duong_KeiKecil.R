...
DiD.data <- DiD.data %>% 
  ...
  mutate(MAIndex = Entertain + 2*PhoneCombined + 3*Satellite + 4*TV + 5*Generator + 6*BoatNoMotor + 7*BoatOutboard + 8*BoatInboard + 9*Bicycle + 10*Motorcycle + 11*CarTruck,
        Household_asset = Entertain + 2*PhoneCombined + 3*Satellite + 4*TV + 5*Generator,
...
DiD.data.Kei <- DiD.data %>% 
  filter(MPAID ==17)

for (i in 1:ncol(DiD.data.Kei)){
  
  print(paste0(names(DiD.data.Kei)[i]," (",class(DiD.data.Kei[,i]),")"))
  
  if(length(unique(DiD.data.Kei[,i]))>25 & class(DiD.data.Kei[,i])!="character"){
    print(summary(DiD.data.Kei[,i]))
  }
  
  else{
    if (length(unique(DiD.data.Kei[,i]))<25){
      print(table(DiD.data.Kei[,i]))}
    else{
      print(head(DiD.data.Kei[,i]))}
  }
}
...
export(model.out.MACP.impact1 %>% 
       ...
       "D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/macp_plots_output.csv")
...
export(model.out.MACP.impact1 %>% 
         ...
         arrange(MPAID,Response), 
       "D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/macp_plots_output_standardized_Big5.csv")
...
export(model.out.MACP.impact1.subAsset %>% 
         select(term, estimate, Response, MPAID, std.error, Group, MPAName_short) %>%  
         arrange(MPAID,Response), 
       "D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/macp_plots_output_Asset_subClasses.csv")
...
for (mpa in MPA_name) {
  ...
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_FS_",mpa,".jpg"),width = 12, height = 6)
  ...
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_MT_",mpa,".jpg"),width = 12, height = 6)
  ...
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_MA_",mpa,".jpg"),width = 12, height = 6)
  ...
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_PA_",mpa,".jpg"),width = 12, height = 6)
  ...
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_SE_",mpa,".jpg"),width = 12, height = 6)
  
  
  #library(cowplot)
  #Combine "regular BigFive"
  plot_grid(FS.plot,MT.plot,PA.plot,SE.plot,MA.plot,ncol=3)
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_BigFive_",mpa,".jpg"),width = 12, height = 6)
  ...
  FS.plot <- ggplot(filter(mpa.impact.data,Response=="FSIndex_z"),aes(x=term,y=estimate)) + 
    ...
    geom_hline(yintercept = 0, linetype = "dashed") +
    labs(x="",y="Impact estimate", title="Food Security") 
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_FS_z_",mpa,".jpg"),width = 12, height = 6)
  ...
  MT.plot <- ggplot(filter(mpa.impact.data,Response=="MTIndex_z"),aes(x=term,y=estimate)) + 
    ...
    geom_hline(yintercept = 0, linetype = "dashed") +
    labs(x="",y="Impact estimate", title="Marine Tenure")  
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_MT_z_",mpa,".jpg"),width = 12, height = 6)
  ...
  MA.plot <- ggplot(filter(mpa.impact.data,Response=="MAIndex_z"),aes(x=term,y=estimate)) + 
    ...
    geom_hline(yintercept = 0, linetype = "dashed") +
    labs(x="",y="Impact estimate", title="Material Assets")  
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_MA_z_",mpa,".jpg"),width = 12, height = 6)
  ...
  PA.plot <- ggplot(filter(mpa.impact.data,Response=="PAIndex_z"),aes(x=term,y=estimate)) + 
    ...
    geom_hline(yintercept = 0, linetype = "dashed") +
    labs(x="",y="Impact estimate", title="Place Attachment")  
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_PA_z_",mpa,".jpg"),width = 12, height = 6)
  ...
  SE.plot <- ggplot(filter(mpa.impact.data,Response=="SERate_z"),aes(x=term,y=estimate)) + 
    ...
    geom_hline(yintercept = 0, linetype = "dashed") +
    labs(x="",y="Impact estimate", title="School Enrollment")  
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_SE_z_",mpa,".jpg"),width = 12, height = 6)
  
  #Combine "standardize BigFive"
  plot_grid(FS.plot,MT.plot,PA.plot,SE.plot,MA.plot,ncol=3)
  ggsave(paste0("D:/Dropbox/1_Social/Outputs/impact_analysis/Kei Kecil/plots/",mpa,"/DiD_BigFive_z_",mpa,".jpg"),width = 12, height = 6)
