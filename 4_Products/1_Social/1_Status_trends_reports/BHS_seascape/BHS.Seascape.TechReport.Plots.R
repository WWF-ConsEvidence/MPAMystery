...
source("2_Social/TechnicalReports/BHS/Datasets/BHS.Seascape.TechReport.Datasets.R")
...
dir.create(paste("2_Social/FlatDataFiles/BHS/TechReportOutput/BHS_level_Analysis/Figures--produced",
                 format(Sys.Date(),format="%Y_%m_%d"),sep="_"))

FigureFileName <- paste("2_Social/FlatDataFiles/BHS/TechReportOutput/BHS_level_Analysis/Figures--produced",
                        format(Sys.Date(),format="%Y_%m_%d"),sep="_")
