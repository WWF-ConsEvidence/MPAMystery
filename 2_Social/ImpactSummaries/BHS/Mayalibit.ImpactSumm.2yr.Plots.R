...
# 
# ---- inputs ----
#  1) Source Mayalibit.ImpactSumm.2yr.SigTests.R 
...
source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Mayalibit.ImpactSumm.2yr.SigTests.R')
...
Maya.MPAimpact.summ.fs.st <- ggplot(data=Maya.2yr.status.trend,
                                    aes(Year,
                                        FS)) +
...
Maya.MPAimpact.summ.ma.st <- ggplot(data=Maya.2yr.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Maya.MPAimpact.summ.pa.st <- ggplot(data=Maya.2yr.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Maya.MPAimpact.summ.mt.st <- ggplot(data=Maya.2yr.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Maya.MPAimpact.summ.se.st <- ggplot(data=Maya.2yr.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
