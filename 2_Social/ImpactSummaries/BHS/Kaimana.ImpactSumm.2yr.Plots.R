...
# 
# ---- inputs ----
#  1) Source Kaimana.ImpactSumm.2yr.SigTests.R 
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
# ---- SECTION 1: Source Kaimana 2Yr Impact Summary Statistical Code ----
#
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 


source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Kaimana.ImpactSumm.2yr.SigTests.R')
...
Kai.MPAimpact.summ.fs.st <- ggplot(data=Kai.2yr.status.trend,
                                    aes(Year,
                                        FS)) +
...
Kai.MPAimpact.summ.ma.st <- ggplot(data=Kai.2yr.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kai.MPAimpact.summ.pa.st <- ggplot(data=Kai.2yr.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kai.MPAimpact.summ.mt.st <- ggplot(data=Kai.2yr.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kai.MPAimpact.summ.se.st <- ggplot(data=Kai.2yr.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
