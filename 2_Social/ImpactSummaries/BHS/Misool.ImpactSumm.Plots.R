# 
# code:  Misool Impact Summary Plots - 2 and 4 year impacts
# 
...
# 
# ---- inputs ----
#  1) Source Misool.ImpactSumm.SigTests.R 
...
# 
# ---- code sections ----
#  1) Source Misool Impact Summary Statistical Code
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
# ---- SECTION 1: Source Misool Impact Summary Statistical Code ----
#
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 


source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Misool.ImpactSumm.SigTests.R')
...
Mis.MPAimpact.summ.fs.st <- ggplot(data=Mis.status.trend,
                                    aes(Year,
                                        FS)) +
  ...
  scale_x_discrete(labels=c(as.character(Mis.sig.labs["FS","xaxis.st.baselabs"]),
                            as.character(Mis.sig.labs["FS","xaxis.st.2yrlabs"]),
                            as.character(Mis.sig.labs["FS","xaxis.st.4yrlabs"]))) +
...
Mis.MPAimpact.summ.ma.st <- ggplot(data=Mis.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
           ...
           position="dodge",
           show.legend=F) +
  scale_x_discrete(labels=c(as.character(Mis.sig.labs["MA","xaxis.st.baselabs"]),
                            as.character(Mis.sig.labs["MA","xaxis.st.2yrlabs"]),
                            as.character(Mis.sig.labs["MA","xaxis.st.4yrlabs"]))) +
...
Mis.MPAimpact.summ.pa.st <- ggplot(data=Mis.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
  ...
  geom_errorbar(aes(ymin=PA-PAErr,
                ...
                position=position_dodge(width=0.5),
                show.legend=F) +
  scale_x_discrete(labels=c(as.character(Mis.sig.labs["PA","xaxis.st.baselabs"]),
                            as.character(Mis.sig.labs["PA","xaxis.st.2yrlabs"]),
                            as.character(Mis.sig.labs["PA","xaxis.st.4yrlabs"]))) +
...
Mis.MPAimpact.summ.mt.st <- ggplot(data=Mis.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
  ...
  scale_y_continuous(limits=c(0,5),
                     expand=c(0,0)) +
  scale_x_discrete(labels=c(as.character(Mis.sig.labs["MT","xaxis.st.baselabs"]),
                            as.character(Mis.sig.labs["MT","xaxis.st.2yrlabs"]),
                            as.character(Mis.sig.labs["MT","xaxis.st.4yrlabs"]))) +
  scale_fill_manual(values=fill.cols.MPAimpact.summ) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
...
Mis.MPAimpact.summ.se.st <- ggplot(data=Mis.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
           ...
           position="dodge",
           show.legend=F) +
  scale_x_discrete(labels=c(as.character(Mis.sig.labs["SE","xaxis.st.baselabs"]),
                            as.character(Mis.sig.labs["SE","xaxis.st.2yrlabs"]),
                            as.character(Mis.sig.labs["SE","xaxis.st.4yrlabs"]))) +
...
Mis.MPAimpact.summ.fs.i <- ggplot(data=Mis.impacts,
                                   aes(x=Year,y=FS)) +
  ...
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position=position_dodge(width=0.5),
                show.legend=F) +
  geom_point(data=Mis.impact.arrows.2yr,
             aes(x=x,y=FS,shape="2yr"),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_point(data=Mis.impact.arrows.4yr,
             aes(x=x,y=FS,shape="4yr"),
             fill="black",
             size=2.75,
             show.legend=F) +
  annotate("text",y=Mis.sig.pos["FS","TwoYr"],x=0.65,
           label=Mis.sig.labs["FS","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Mis.sig.pos["FS","FourYr"],x=1.65,
           label=Mis.sig.labs["FS","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Mis.impacts$FS[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="2 Year"]>
                                             Mis.impacts$FS[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Mis.impacts$FS[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="4 Year"]>
                                             Mis.impacts$FS[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.ma.i <- ggplot(data=Mis.impacts,
                                   aes(x=Year,y=MA)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Mis.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Mis.sig.pos["MA","TwoYr"],x=0.65,
           label=Mis.sig.labs["MA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Mis.sig.pos["MA","FourYr"],x=1.65,
           label=Mis.sig.labs["MA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Mis.impacts$MA[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="2 Year"]>
                                             Mis.impacts$MA[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Mis.impacts$MA[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="4 Year"]>
                                             Mis.impacts$MA[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.pa.i <- ggplot(data=Mis.impacts,
                                   aes(x=Year,y=PA)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Mis.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Mis.sig.pos["PA","TwoYr"],x=0.65,
           label=Mis.sig.labs["PA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Mis.sig.pos["PA","FourYr"],x=1.65,
           label=Mis.sig.labs["PA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Mis.impacts$PA[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="2 Year"]>
                                             Mis.impacts$PA[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Mis.impacts$PA[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="4 Year"]>
                                             Mis.impacts$PA[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.pa.labs.i + plot.guides.MPAimpact.summ

# ---- 3.4 Marine Tenure ----

Mis.MPAimpact.summ.mt.i <- ggplot(data=Mis.impacts,
                                   aes(x=Year,y=MT)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Mis.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Mis.sig.pos["MT","TwoYr"],x=0.65,
           label=Mis.sig.labs["MT","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Mis.sig.pos["MT","FourYr"],x=1.65,
           label=Mis.sig.labs["MT","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Mis.impacts$MT[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="2 Year"]>
                                             Mis.impacts$MT[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Mis.impacts$MT[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="4 Year"]>
                                             Mis.impacts$MT[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.mt.labs.i + plot.guides.MPAimpact.summ

# ---- 3.5 School Enrollment ----

Mis.MPAimpact.summ.se.i <- ggplot(data=Mis.impacts,
                                   aes(x=Year,y=SE)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Mis.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Mis.sig.pos["SE","TwoYr"],x=0.65,
           label=Mis.sig.labs["SE","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Mis.sig.pos["SE","FourYr"],x=1.65,
           label=Mis.sig.labs["SE","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Mis.impacts$SE[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="2 Year"]>
                                             Mis.impacts$SE[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Mis.impacts$SE[Mis.impacts$Treatment=="MPA" & Mis.impacts$Year=="4 Year"]>
                                             Mis.impacts$SE[Mis.impacts$Treatment=="Control" & Mis.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
# - 2 year impacts
snapshot.Mis.MPAimpact.summ.2yr <- ggplot(data=Mis.2yr.std.impacts,
                                           aes(x=Domain,
                                               y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Mis.sig.labs[,"snapshot.2yrlabs"]) +
...
# - 4 year impacts
snapshot.Mis.MPAimpact.summ.4yr <- ggplot(data=Mis.4yr.std.impacts,
                                           aes(x=Domain,
                                               y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Mis.sig.labs[,"snapshot.4yrlabs"]) +
  scale_y_continuous(limits=c(-0.75,0.75),
                     breaks=c(seq(-0.5,0.5,by=0.25))) +
  scale_fill_manual(values=c(alpha("#65B65E",0.7),alpha("#1B448B",0.7)),
                    name="Direction of\nImpact",
...
Mis.snapshot.legend.plot <-
  ggplot(data=Mis.4yr.std.impacts,
         aes(x=Domain,
             y=Std.impact)) +
  geom_bar(data=seascape.impact.4yr,
           aes(x=Domain,
...
Mis.snapshot.legend <- g_legend(Mis.snapshot.legend.plot)

snapshot.Mis.MPAimpact.bothyr <-
  grid.arrange(arrangeGrob(snapshot.Mis.MPAimpact.summ.2yr,
                           snapshot.Mis.MPAimpact.summ.4yr,
                           ncol=2),
               Mis.snapshot.legend,
...
dir.create(paste("2_Social/FlatDataFiles/BHS/ImpactSummOutput/Misool/Figures--produced",
                 format(Sys.Date(),format="%Y_%m_%d"),sep="_"))

FigureFileName <- paste("2_Social/FlatDataFiles/BHS/ImpactSummOutput/Misool/Figures--produced",
                        format(Sys.Date(),format="%Y_%m_%d"),sep="_")
...
plot(Mis.MPAimpact.summ.fs.st)
dev.off()

png(paste(FigureFileName,"FS.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.fs.i)
dev.off()
...
png(paste(FigureFileName,"MA.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.ma.st)
dev.off()

png(paste(FigureFileName,"MA.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.ma.i)
dev.off()
...
png(paste(FigureFileName,"MT.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.mt.st)
dev.off()

png(paste(FigureFileName,"MT.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.mt.i)
dev.off()
...
png(paste(FigureFileName,"PA.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.pa.st)
dev.off()

png(paste(FigureFileName,"PA.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.pa.i)
dev.off()
...
png(paste(FigureFileName,"SE.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.se.st)
dev.off()

png(paste(FigureFileName,"SE.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Mis.MPAimpact.summ.se.i)
dev.off()
...
grid.newpage()
grid.draw(snapshot.Mis.MPAimpact.bothyr)
dev.off()
