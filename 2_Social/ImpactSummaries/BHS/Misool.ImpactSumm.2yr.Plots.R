# 
# code:  Misool 2Yr Impact Summary Plots
# 
...
# 
# ---- inputs ----
#  1) Source Misool.ImpactSumm.2yr.SigTests.R 
...
# 
# ---- code sections ----
#  1) Source Misool 2Yr Impact Summary Statistical Code
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
# ---- SECTION 1: Source Misool 2Yr Impact Summary Statistical Code ----
#
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 


source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Misool.ImpactSumm.2yr.SigTests.R')
...
Mis.MPAimpact.summ.fs.st <- ggplot(data=Mis.2yr.status.trend,
                                    aes(Year,
                                        FS)) +
...
Mis.MPAimpact.summ.ma.st <- ggplot(data=Mis.2yr.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.pa.st <- ggplot(data=Mis.2yr.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.mt.st <- ggplot(data=Mis.2yr.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.se.st <- ggplot(data=Mis.2yr.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Mis.MPAimpact.summ.fs.i <- ggplot(data=Mis.2yr.impacts,
  ...
  geom_segment(aes(x=0.6,xend=0.6,y=FS[Treatment=="Control"],yend=FS[Treatment=="MPA"]),
               lineend="square",
               size=1) +
  geom_point(data=Mis.impact.arrows,
             aes(x=x,y=FS,shape=""),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Mis.sig.pos["FS",],x=0.65,
           label=Mis.sig.labs["FS","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Mis.2yr.impacts$FS[Mis.2yr.impacts$Treatment=="MPA"]>
                                     Mis.2yr.impacts$FS[Mis.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.ma.i <- ggplot(data=Mis.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MA-MAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Mis.sig.pos["MA",],x=0.65,
           label=Mis.sig.labs["MA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Mis.2yr.impacts$MA[Mis.2yr.impacts$Treatment=="MPA"]>
                                     Mis.2yr.impacts$MA[Mis.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.pa.i <- ggplot(data=Mis.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=PA-PAErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Mis.sig.pos["PA",],x=0.65,
           label=Mis.sig.labs["PA","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Mis.2yr.impacts$PA[Mis.2yr.impacts$Treatment=="MPA"]>
                                     Mis.2yr.impacts$PA[Mis.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.mt.i <- ggplot(data=Mis.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=MT-MTErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Mis.sig.pos["MT",],x=0.65,
           label=Mis.sig.labs["MT","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Mis.2yr.impacts$MT[Mis.2yr.impacts$Treatment=="MPA"]>
                                     Mis.2yr.impacts$MT[Mis.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
Mis.MPAimpact.summ.se.i <- ggplot(data=Mis.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=SE-SEErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Mis.sig.pos["SE",],x=0.65,
           label=Mis.sig.labs["SE","impact.labs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  scale_fill_manual(labels=c("MPA","Control"),
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=ifelse(Mis.2yr.impacts$SE[Mis.2yr.impacts$Treatment=="MPA"]>
                                     Mis.2yr.impacts$SE[Mis.2yr.impacts$Treatment=="Control"],24,25),
                     labels="Direction of\nImpact (+/-)") +
...
snapshot.Mis.MPAimpact.summ <- ggplot(data=Mis.2yr.std.impacts,
                                       aes(x=Domain,
                                           y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Mis.sig.labs[,"snapshot.labs"]) +
  ...
  labs(x="Human Well-Being Domain\n ",y="\n MPA Impact",
       title="Social Impacts of Misool Selatan Timur MPA") +
