...
# 
# ---- inputs ----
#  1) Source Kofiau.ImpactSumm.2yr.SigTests.R 
...
source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Kofiau.ImpactSumm.2yr.SigTests.R')
...
Kof.MPAimpact.summ.fs.st <- ggplot(data=Kof.2yr.status.trend,
                                    aes(Year,
                                        FS)) +
...
Kof.MPAimpact.summ.ma.st <- ggplot(data=Kof.2yr.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.pa.st <- ggplot(data=Kof.2yr.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.mt.st <- ggplot(data=Kof.2yr.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.se.st <- ggplot(data=Kof.2yr.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
...
Kof.MPAimpact.summ.se.i <- ggplot(data=Kof.2yr.impacts,
  ...
  geom_errorbar(aes(ymin=SE-SEErr,
                ...
                position="dodge",
                show.legend=F) +
  annotate("text",y=Kof.sig.pos["SE",],x=0.65,
