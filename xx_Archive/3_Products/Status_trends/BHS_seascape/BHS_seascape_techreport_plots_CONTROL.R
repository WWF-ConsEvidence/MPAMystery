...
fillcols.status.Control <- c("NotDummy"=alpha("#303030",0.95),"Dummy"=alpha("#FFFFFF",0))
fillcols.trend.Control <- c(alpha("#303030",0.95))

errcols.status.Control <- c("NotDummy"=alpha("#303030",0.95),"Dummy"=alpha("#FFFFFF",0))
errcols.trend.Control <- c(alpha("#303030",0.95))
...
BHS.fs.annexplot <- 
  ...
  scale_alpha_manual(name="",
                     ...
                     na.translate=FALSE) +
  scale_fill_manual(values=fillcols.status.Control) +
  scale_colour_manual(values=errcols.status.Control) +
...
dir.create(paste("x_Flat_data_files/1_Social/Outputs/BHS_level_Analysis/CONTROL_Figures--produced",
                 format(Sys.Date(),format="%Y_%m_%d"),sep="_"))

FigureFileName <- paste("x_Flat_data_files/1_Social/Outputs/BHS_level_Analysis/CONTROL_Figures--produced",
                        format(Sys.Date(),format="%Y_%m_%d"),sep="_")
...
png(paste(FigureFileName,"CONTROL.FS.annex.png",sep="/"),
...
png(paste(FigureFileName,"CONTROL.MA.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
...
png(paste(FigureFileName,"CONTROL.PA.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
...
png(paste(FigureFileName,"CONTROL.MT.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
...
png(paste(FigureFileName,"CONTROL.SE.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
...
png(paste(FigureFileName,"CONTROL.TimeMarket.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
...
png(paste(FigureFileName,"CONTROL.DaysUnwell.annex.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
