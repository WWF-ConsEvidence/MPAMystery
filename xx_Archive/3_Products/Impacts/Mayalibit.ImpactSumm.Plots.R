# 
# code:  Mayalibit Impact Summary Plots - 2 and 4 year impacts
# 
...
# 
# ---- inputs ----
#  1) Source Mayalibit.ImpactSumm.SigTests.R 
...
# 
# ---- code sections ----
#  1) Source Mayalibit Impact Summary Statistical Code
...
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#
# ---- SECTION 1: Source Mayalibit Impact Summary Statistical Code ----
#
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 


source('2_Social/ImpactSummaries/BHS/SignificanceTestCodes/Mayalibit.ImpactSumm.SigTests.R')
...
Maya.MPAimpact.summ.fs.st <- ggplot(data=Maya.status.trend,
                                    aes(Year,
                                        FS)) +
  ...
  scale_x_discrete(labels=c(as.character(Maya.sig.labs["FS","xaxis.st.baselabs"]),
                            as.character(Maya.sig.labs["FS","xaxis.st.2yrlabs"]),
                            as.character(Maya.sig.labs["FS","xaxis.st.4yrlabs"]))) +
...
Maya.MPAimpact.summ.ma.st <- ggplot(data=Maya.status.trend,
                                    aes(Year,
                                        MA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
           ...
           position="dodge",
           show.legend=F) +
  scale_x_discrete(labels=c(as.character(Maya.sig.labs["MA","xaxis.st.baselabs"]),
                            as.character(Maya.sig.labs["MA","xaxis.st.2yrlabs"]),
                            as.character(Maya.sig.labs["MA","xaxis.st.4yrlabs"]))) +
...
Maya.MPAimpact.summ.pa.st <- ggplot(data=Maya.status.trend,
                                    aes(Year,
                                        PA)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
  ...
  geom_errorbar(aes(ymin=PA-PAErr,
                ...
                position=position_dodge(width=0.5),
                show.legend=F) +
  scale_x_discrete(labels=c(as.character(Maya.sig.labs["PA","xaxis.st.baselabs"]),
                            as.character(Maya.sig.labs["PA","xaxis.st.2yrlabs"]),
                            as.character(Maya.sig.labs["PA","xaxis.st.4yrlabs"]))) +
...
Maya.MPAimpact.summ.mt.st <- ggplot(data=Maya.status.trend,
                                    aes(Year,
                                        MT)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
  ...
  scale_y_continuous(limits=c(0,5),
                     expand=c(0,0)) +
  scale_x_discrete(labels=c(as.character(Maya.sig.labs["MT","xaxis.st.baselabs"]),
                            as.character(Maya.sig.labs["MT","xaxis.st.2yrlabs"]),
                            as.character(Maya.sig.labs["MT","xaxis.st.4yrlabs"]))) +
  scale_fill_manual(values=fill.cols.MPAimpact.summ) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
...
Maya.MPAimpact.summ.se.st <- ggplot(data=Maya.status.trend,
                                    aes(Year,
                                        SE)) +
  geom_bar(aes(fill=Treatment),
           width=0.5,
           ...
           position="dodge",
           show.legend=F) +
  scale_x_discrete(labels=c(as.character(Maya.sig.labs["SE","xaxis.st.baselabs"]),
                            as.character(Maya.sig.labs["SE","xaxis.st.2yrlabs"]),
                            as.character(Maya.sig.labs["SE","xaxis.st.4yrlabs"]))) +
...
Maya.MPAimpact.summ.fs.i <- ggplot(data=Maya.impacts,
                                   aes(x=Year,y=FS)) +
  ...
  geom_errorbar(aes(ymin=FS-FSErr,
                ...
                position=position_dodge(width=0.5),
                show.legend=F) +
  geom_point(data=Maya.impact.arrows.2yr,
             aes(x=x,y=FS,shape="2yr"),
             fill="black",
             size=2.75,
             show.legend=F) +
  geom_point(data=Maya.impact.arrows.4yr,
             aes(x=x,y=FS,shape="4yr"),
             fill="black",
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["FS","TwoYr"],x=0.65,
           label=Maya.sig.labs["FS","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Maya.sig.pos["FS","FourYr"],x=1.65,
           label=Maya.sig.labs["FS","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Maya.impacts$FS[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="2 Year"]>
                                             Maya.impacts$FS[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Maya.impacts$FS[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="4 Year"]>
                                             Maya.impacts$FS[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
Maya.MPAimpact.summ.ma.i <- ggplot(data=Maya.impacts,
                                   aes(x=Year,y=MA)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Maya.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["MA","TwoYr"],x=0.65,
           label=Maya.sig.labs["MA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Maya.sig.pos["MA","FourYr"],x=1.65,
           label=Maya.sig.labs["MA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Maya.impacts$MA[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="2 Year"]>
                                             Maya.impacts$MA[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Maya.impacts$MA[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="4 Year"]>
                                             Maya.impacts$MA[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
Maya.MPAimpact.summ.pa.i <- ggplot(data=Maya.impacts,
                                   aes(x=Year,y=PA)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Maya.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["PA","TwoYr"],x=0.65,
           label=Maya.sig.labs["PA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Maya.sig.pos["PA","FourYr"],x=1.65,
           label=Maya.sig.labs["PA","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Maya.impacts$PA[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="2 Year"]>
                                             Maya.impacts$PA[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Maya.impacts$PA[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="4 Year"]>
                                             Maya.impacts$PA[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.pa.labs.i + plot.guides.MPAimpact.summ

# ---- 3.4 Marine Tenure ----

Maya.MPAimpact.summ.mt.i <- ggplot(data=Maya.impacts,
                                   aes(x=Year,y=MT)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Maya.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["MT","TwoYr"],x=0.65,
           label=Maya.sig.labs["MT","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Maya.sig.pos["MT","FourYr"],x=1.65,
           label=Maya.sig.labs["MT","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Maya.impacts$MT[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="2 Year"]>
                                             Maya.impacts$MT[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Maya.impacts$MT[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="4 Year"]>
                                             Maya.impacts$MT[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
  plot.theme.MPAimpact.summ + plot.mt.labs.i + plot.guides.MPAimpact.summ

# ---- 3.5 School Enrollment ----

Maya.MPAimpact.summ.se.i <- ggplot(data=Maya.impacts,
                                   aes(x=Year,y=SE)) +
  geom_bar(aes(fill=Treatment,width=0.5,group=Treatment),
           stat="identity",
           position="dodge",
  ...
  geom_point(data=Maya.impact.arrows.4yr,
             ...
             size=2.75,
             show.legend=F) +
  annotate("text",y=Maya.sig.pos["SE","TwoYr"],x=0.65,
           label=Maya.sig.labs["SE","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  annotate("text",y=Maya.sig.pos["SE","FourYr"],x=1.65,
           label=Maya.sig.labs["SE","impact.2yrlabs"],
           colour="black",
           size=4,
           lineheight=0.4) +
  ...
  scale_size_manual(values=0.75) +
  scale_colour_manual(values=err.cols.MPAimpact.summ) +
  scale_shape_manual(values=c("2yr"=ifelse(Maya.impacts$SE[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="2 Year"]>
                                             Maya.impacts$SE[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="2 Year"],24,25),
                              "4yr"=ifelse(Maya.impacts$SE[Maya.impacts$Treatment=="MPA" & Maya.impacts$Year=="4 Year"]>
                                             Maya.impacts$SE[Maya.impacts$Treatment=="Control" & Maya.impacts$Year=="4 Year"],24,25)),
                     labels="Direction of\nImpact (+/-)") +
...
# - 2 year impacts
snapshot.Maya.MPAimpact.summ.2yr <- ggplot(data=Maya.2yr.std.impacts,
                                           aes(x=Domain,
                                               y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Maya.sig.labs[,"snapshot.2yrlabs"]) +
...
# - 4 year impacts
snapshot.Maya.MPAimpact.summ.4yr <- ggplot(data=Maya.4yr.std.impacts,
                                           aes(x=Domain,
                                               y=Std.impact)) +
  ...
  geom_hline(aes(yintercept=0),
             ...
             colour="#505050",
             show.legend=F) +
  scale_x_discrete(labels=Maya.sig.labs[,"snapshot.4yrlabs"]) +
  scale_y_continuous(limits=c(-0.75,0.75),
                     breaks=c(seq(-0.5,0.5,by=0.25))) +
  scale_fill_manual(values=c(alpha("#65B65E",0.7),alpha("#1B448B",0.7)),
                    name="Direction of\nImpact",
...
Maya.snapshot.legend.plot <-
  ggplot(data=Maya.4yr.std.impacts,
         aes(x=Domain,
             y=Std.impact)) +
  geom_bar(data=seascape.impact.4yr,
           aes(x=Domain,
...
Maya.snapshot.legend <- g_legend(Maya.snapshot.legend.plot)

snapshot.Maya.MPAimpact.bothyr <-
  grid.arrange(arrangeGrob(snapshot.Maya.MPAimpact.summ.2yr,
                           snapshot.Maya.MPAimpact.summ.4yr,
                           ncol=2),
               Maya.snapshot.legend,
...
dir.create(paste("2_Social/FlatDataFiles/BHS/ImpactSummOutput/Mayalibit/Figures--produced",
                 format(Sys.Date(),format="%Y_%m_%d"),sep="_"))

FigureFileName <- paste("2_Social/FlatDataFiles/BHS/ImpactSummOutput/Mayalibit/Figures--produced",
                        format(Sys.Date(),format="%Y_%m_%d"),sep="_")
...
plot(Maya.MPAimpact.summ.fs.st)
dev.off()

png(paste(FigureFileName,"FS.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.fs.i)
dev.off()
...
png(paste(FigureFileName,"MA.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.ma.st)
dev.off()

png(paste(FigureFileName,"MA.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.ma.i)
dev.off()
...
png(paste(FigureFileName,"MT.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.mt.st)
dev.off()

png(paste(FigureFileName,"MT.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.mt.i)
dev.off()
...
png(paste(FigureFileName,"PA.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.pa.st)
dev.off()

png(paste(FigureFileName,"PA.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.pa.i)
dev.off()
...
png(paste(FigureFileName,"SE.status.trend.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.se.st)
dev.off()

png(paste(FigureFileName,"SE.impact.png",sep="/"),
    units="in",height=7.5,width=7.5,res=400)
plot(Maya.MPAimpact.summ.se.i)
dev.off()
...
grid.newpage()
grid.draw(snapshot.Maya.MPAimpact.bothyr)
dev.off()
