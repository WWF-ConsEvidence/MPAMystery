...
HHLivelihood <- HHData[,c("HouseholdID", "MPAID", "SettlementID", "PrimaryLivelihoodClean", 
                          ...
                          "FreqEatFishClean", "PercentProteinFishClean", 
                          "EconStatusReasonClean", "TimeMarketClean")]

HHDemos <- HHData[,c("HouseholdID", "MPAID", "SettlementID", "ReligionClean", "YrResidentClean", 
                     "HHDeathClean", "HHBirthClean", "MonitoringYear")]
...
BigFive.allvar <- left_join(BigFive.allvar,HHData[,c("HouseholdID","MonitoringYear")])
...
BigFive.ControlGroup <- cbind.data.frame("SettlementID"=rep.int(NA,5),
                                         "SettlementName"=rep.int("Control",5),
                                         BigFive.ControlGroup[,"MPAID"],
                                         "Treatment"=rep.int(0,5),
                                         BigFive.ControlGroup[,c("MonitoringYear", "FSMean", "FSErr", "MAMean", "MAErr", 
                                                                 "PAMean", "PAErr", "MTMean", "MTErr", "SEMean", "SEErr")])
...
BigFive.MPAGroup <- cbind.data.frame("SettlementID"=rep.int(NA,5),
                                     "SettlementName"=rep.int("MPA",5),
                                     BigFive.MPAGroup[,"MPAID"],
                                     "Treatment"=rep.int(1,5),
                                     BigFive.MPAGroup[,c("MonitoringYear", "FSMean", "FSErr", "MAMean", "MAErr", "PAMean", 
...
HHDemos.context.1 <- left_join(HHDemos[,c("HouseholdID", "MPAID", "SettlementID", "ReligionClean", "YrResidentClean", 
                                          "MonitoringYear")],
                               MPANames,
                               by="MPAID")
HHDemos.context.1 <- left_join(HHDemos.context.1,
                               ...
                               by="HouseholdID")
HHDemos.context.1 <- left_join(HHDemos.context.1,
                               BigFive[,c("HouseholdID", "SettlementName", "Treatment", "InterviewYear", 
                                          "SERate")],
                               by="HouseholdID")
HHDemos.context.1 <- left_join(HHDemos.context.1,
                               HHLivelihood[,c("HouseholdID", "PrimaryLivelihoodClean", "SecondaryLivelihoodClean", 
                                               "TertiaryLivelihoodClean", "FreqFishClean", "FreqSaleFishClean", 
                                               "PercentIncFishClean", "MajFishTechniqueClean", "FreqEatFishClean", 
                                               "PercentProteinFishClean", "TimeMarketClean")],
                               by="HouseholdID")
HHDemos.context.1 <- left_join(HHDemos.context.1,
