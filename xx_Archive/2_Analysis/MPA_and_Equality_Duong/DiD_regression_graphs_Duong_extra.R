...
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_BigFive_seascape.jpg"),width = 12, height = 6)
...
plot_grid(FS.plot,MT.plot,PA.plot,SE.plot,MA.plot,ncol=3)
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_BigFive_z_seascape.jpg"),width = 12, height = 6)
...
#+ facet_grid(.~Response)
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_FS_MPAlevel.jpg"),width = 12, height = 6)
...
MT.plot <- ggplot(filter(model.out.mpalevel1,Response=="MTIndex"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Marine Tenure")  +
  scale_colour_manual(values = c("skyblue3", "blue")) 
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_MT_MPAlevel.jpg"),width = 12, height = 6)
...
PA.plot <- ggplot(filter(model.out.mpalevel1,Response=="PAIndex"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Place Attachment")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_PA_MPAlevel.jpg"),width = 12, height = 6)
...
MA.plot <- ggplot(filter(model.out.mpalevel1,Response=="MAIndex"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Material Assets")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_MA_MPAlevel.jpg"),width = 12, height = 6)
...
SE.plot <- ggplot(filter(model.out.mpalevel1,Response=="SERate"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="School Enrollment")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_SE_MPAlevel.jpg"),width = 12, height = 6)
...
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_FS_MPAlevel.jpg"),width = 12, height = 6)
...
MT.plot_z <- ggplot(filter(model.out.mpalevel1,Response=="MTIndex_z"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Marine Tenure")  +
  scale_colour_manual(values = c("skyblue3", "blue")) 
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_MT_MPAlevel.jpg"),width = 12, height = 6)
...
PA.plot_z <- ggplot(filter(model.out.mpalevel1,Response=="PAIndex_z"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Place Attachment")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_PA_MPAlevel.jpg"),width = 12, height = 6)
...
MA.plot_z <- ggplot(filter(model.out.mpalevel1,Response=="MAIndex_z"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="Material Assets")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_MA_MPAlevel.jpg"),width = 12, height = 6)
...
SE.plot_z <- ggplot(filter(model.out.mpalevel1,Response=="SERate_z"),aes(x=MPAName_short,y=estimate, color=term),group=1) + 
  ...
  labs(x="",y="DiD estimate", title="School Enrollment")  +
  scale_colour_manual(values = c("skyblue3", "blue"))
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_SE_MPAlevel.jpg"),width = 12, height = 6)
...
#library(cowplot)
plot_grid(FS.plot,MT.plot,PA.plot,SE.plot,MA.plot,ncol=3)
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_BigFive_MPAlevel.jpg"),width = 12, height = 6)
...
ggsave(paste0("R:/Gill/MPAMystery/x_Flat_data_files/1_Social/Outputs/DiD_result/stderr_band/","DiD_z_BigFive_MPAlevel.jpg"),width = 12, height = 6)
