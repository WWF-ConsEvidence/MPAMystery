...
pacman::p_load(rio, plyr, dplyr, openxlsx, chron)


Alor_WELLBEING <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_WELLBEING.csv') %>%
  filter(!is.na(HouseholdID))
Alor_DEMOGRAPHIC <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_DEMOGRAPHIC.csv') %>%
  filter(!is.na(HouseholdID))
Alor_BIRTHS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_BIRTHS.csv') %>%
  filter(!is.na(HouseholdID))
Alor_DEATHS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_DEATHS.csv') %>%
  filter(!is.na(HouseholdID))
Alor_ORGANIZATION <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_ORGANIZATION.csv') %>%
  filter(!is.na(HouseholdID))
Alor_NMORGANIZATION <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_NMORGANIZATION.csv') %>%
  filter(!is.na(HouseholdID))
Alor_LTHREAT <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_LTHREAT.csv') %>%
  filter(!is.na(HouseholdID))
Alor_LSTEPS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_LSTEPS.csv') %>%
  filter(!is.na(HouseholdID))
Alor_GTHREAT <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_GTHREAT.csv') %>%
  filter(!is.na(HouseholdID))
Alor_GSTEPS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Selat_Pantar/1_HWB/Post-QAQC_FlatFiles_2019_1006/ALOR_2017_post-QAQC_GSTEPS.csv') %>%
  filter(!is.na(HouseholdID))

Flotim_WELLBEING <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_WELLBEING.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_DEMOGRAPHIC <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_DEMOGRAPHIC.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_BIRTHS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_BIRTHS.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_DEATHS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_DEATHS.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_ORGANIZATION <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_ORGANIZATION.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_NMORGANIZATION <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_NMORGANIZATION.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_LTHREAT <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_LTHREAT.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_LSTEPS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_LSTEPS.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_GTHREAT <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_GTHREAT.csv')  %>%
  filter(!is.na(HouseholdID))
Flotim_GSTEPS <- import('C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/3_QAQC/Flores_Timur/1_HWB/Post-QAQC_FlatFiles_2019_0801/FLOTIM_2017_post-QAQC_GSTEPS.csv')  %>%
  filter(!is.na(HouseholdID))
...
Alor_WELLBEING <- 
  Alor_WELLBEING %>% plyr::rename(c("HouseholdID"="EntryHouseholdID")) %>%
  ...
  dplyr::mutate(HouseholdID=seq(Max_ID_per_table_master$HouseholdID+1,Max_ID_per_table_master$HouseholdID+length(EntryHouseholdID), by=1),
                EntryComputerIdentifier="ALOR_FLOTIM_2017_post-QAQC_2019_1006",
...
Flotim_WELLBEING <- 
  Flotim_WELLBEING %>% plyr::rename(c("HouseholdID"="EntryHouseholdID")) %>%
  .[order(.$SettlementID,.$`KK Code`),] %>%
...
export(Alor_Flotim_DEMOGRAPHIC,'x_Flat_data_files/1_Social/Alor_Flotim_DEMOGRAPHIC.xlsx')
...
saveWorkbook(wb,'C:/Users/claborn-intern/Dropbox (MPAMystery)/MPA_social_data/2_QUALITY_CONTROL/2017_FLORES_TIMUR_ALOR/4_PUSH_MASTER/1_HWB/ALOR_FLOTIM_2017_post-QAQC_2019_1006.xlsx')
