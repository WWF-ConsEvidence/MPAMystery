...
Statusplot.labs <- list(FS=labs(y="Mean household food security",x="Settlement"),
                        ...
                        Conflict=labs(y="Change in social conflict over marine resources (% households)",x="Settlement"),
                        ...
                        Member=labs(y="Households who are a member of an organization (% households)",x="Settlement"),
                        Attendance=labs(y="Marine organization members and meeting attendance",x="Settlement"),
