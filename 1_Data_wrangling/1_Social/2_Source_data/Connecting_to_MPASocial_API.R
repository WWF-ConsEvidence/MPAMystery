...
endpoint <- "death" # this is the name of the api endpoint where you specify the database subtable you want to access
...
# Can optionally filter "MPA"  and/or "InterviewYear" fields in "household" api endpoint call
